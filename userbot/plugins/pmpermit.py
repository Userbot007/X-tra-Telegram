...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "**No name set yet nibba, check ** "
...
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=742506768)\n\n"
                    "`Henlo there, My Owner is busy talking to Tanya so Wait. Specially if u r Gaurav the go cry `"
                    f"{DEFAULTUSER}'s` inbox.\n\n"
                    "Leave your name, phone number, address and 69k$ and hopefully you'll get a reply within 2 light years.`\n\n"
